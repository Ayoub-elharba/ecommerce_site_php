...
<body>
   ...
   <section class="products">
      ...
      <div class="wishlist-total">
         <p>total : <span>DH<?= $grand_total; ?>/-</span></p>
         <a href="Nos huiles.php" class="option-btn">Continuer vos achats</a>
         <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" onclick="return confirm('supprimer tout de la liste souhaits ?');">supprimer tous les éléments</a>
      </div>
